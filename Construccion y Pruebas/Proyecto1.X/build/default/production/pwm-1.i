...
char porcentajeMax = 100;
char porcentajeSubenBaja = 1;

char porcentaje = 0;
char porcentajeC = 100;
...
void init_CCP1_PWM(void) {
    ...
    CCPR1L = (porcentaje * elPR2 / 4);
    CCP1CONbits.DC1B = porcentaje * elPR2 % 4;
...
void init_CCP2_PWM(void) {
    ...
    CCPR2L = porcentajeC * elPR2 / 4;
    CCP2CONbits.DC2B1 = (unsigned char) (( porcentajeC * elPR2 % 4) >> 1 << 1);
    CCP2CONbits.DC2B0 = (unsigned char) (porcentajeC * elPR2 % 2);
